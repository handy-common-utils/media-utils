...
describe('getMediaInfo with real files', () => {
  describe('mp4box parser', () => {
    ...
    it.each(['engine-start.mjpeg.pcms16le.avi', 'engine-start.mpeg2video.mp2.m2ts', 'engine-start.vp9.opus.webm', 'engine-start.wmv2.wmav2.wmv'])(
  ...
  describe('remotion parser', () => {
    ...
    it.each(['engine-start.h264.mp3.mov', 'engine-start.mjpeg.pcms16le.avi', 'engine-start.mpeg2video.mp2.m2ts', 'engine-start.wmv2.wmav2.wmv'])(
      'should fail to parse %s',
      async (filename) => {
        try {
